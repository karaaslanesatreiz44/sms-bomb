...
TOKEN = "MTA3MzAyNjgzMzUzNDE2MDkzNg.GyqAsD.uvIkzu31QkffmkHUiRj-AA09Z2VSPJ_83p-ykU"
gif = ""
adet = 55
saniye = 0
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="Developed by Roixd")
